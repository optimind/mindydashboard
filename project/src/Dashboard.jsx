// Dashboard.jsx — Polished SaaS dashboard view
...
// Mock daily data — 14 days of plausible counts
const CHART_DATA = [
          ...
          return (
            <button key={s.id} onClick={() => toggle(s.id)} style={{
              ...
              <span style={{
                ...
                background: on ? s.color : '#D9E4F5',
              }}/>
              {s.label}
              <span style={{
                font: '500 11px/1 JetBrains Mono',
                color: on ? '#7A89A8' : '#C7CFDC',
              }}>{s.total}</span>
            </button>
          );
        })}
...
// ============== Right column: top inquiries + recent activity ==============
